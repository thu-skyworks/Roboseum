...
为了将机器人学的理论知识与实践更好结合，我们还发起了turtleGripper移动机械臂开源项目，基于turtlebot移动小车、open manipulator机械臂、hokuyo雷达与Kinect摄像头传感，搭建了一个家用机器人，可捡拾散落在低地板上的目标物。我们认为turtleGripper可以成为一个很好的教学平台，可基于turtleGripper实践的知识包括：机器人正逆运动学、路径规划、定位与导航、目标识别、运动控制、目标物抓取、系统架构设计等。

目前所有源码已[公开](https://github.com/Yiping-Steven/turtleGripper)，说明文档和后续功能还在持续完善中。
